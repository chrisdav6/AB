        ...
        <div class="row">
          <div class="col">
            ...
            <ul class="list-unstyled mt-3 ml-0 ml-md-3">
              <li>- Automated measurements of cell proliferation, morphology, barrier function, migration, ect. under flow conditions</li>
