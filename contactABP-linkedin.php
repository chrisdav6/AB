...
<!-- This page is used to catch requests from subdomain setup by Michael -->
<!-- New Google form was created -->
...
<body class="d-flex flex-column">
  ...
  <section id="contact" class="py-4 mb-5">
    <div class="container">
      ...
      <iframe onload="self.scrollTo(0,0)" src="https://docs.google.com/forms/d/e/1FAIpQLSeHutMGklaQHR6hw09tRgs82VKVjV7atKAacN5UwW5ICwz7oQ/viewform?embedded=true" width="100%" height="2300" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
