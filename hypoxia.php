<?php
  $title = "Hypoxia Chambers for ECIS Systems - Applied BioPhysics";
  $metaDesc = "Hypoxia chambers offered by COY labs provide a low oxygen environment ECIS measurements.";
?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 text-center text-md-left mt-4">
          ...
          <hr class="mt-1">
          <p>
            Cells respond to a variety of environmental conditions and having options to apply these varying conditions
            in vitro is essential. At Applied Biophysics, we encourage different avenues of manipulating the environment
            while using the ECIS systems. One way this can be accomplished is by using hypoxia chambers.
          </p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          ...
          <p>
            ...
            researchers to monitor cell behavior and conduct ECIS experiments in a controlled gas environment. The
            cabinet will accept either the 16 or 96 well ECIS Station and fits within a standard tissue culture
            incubator* that is used to regulate the cabinet’s temperature. Optional gas sensors within the cabinet are
            used to measure and regulate the concentration of oxygen and/or carbon dioxide within the cabinet. Pull-out
            shelves provide easy access to the array holder.
          </p>
      ...
      <div class="row my-5">
        <div class="col-md-6">
          ...
          <p>
            The oxygen controller has two ports, one for oxygen and the other for nitrogen/air (or a mixture of carbon
            dioxide and nitrogen/air). The system is designed to automatically maintain hypoxic or hyperoxic conditions
            in the cabinet with oxygen concentration from 0% to 60% (monitors up to 100%).
          </p>
        </div>
        <div class="col-md-6">
