      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="list-group mb-5" id="publication-labels" role="tablist">
            ...
            <a class="list-group-item list-group-item-action" href="#" role="tab" data-filter="<?= $label ?>" data-scroll-ignore><?= $label ?></a>
              ...
              <tr class="publication" data-abstract="<?= $publication->getAbstract() ?>">
                <td>
                  <p>
                    ...
                    <a class="publication-doi" href="<?= $publication->getDoiUrl() ?>" target="_blank">
                      doi:<?= $publication->getElectronicResourceNum() ?>
                    </a>
                    <?php endif; ?>
                    <a href="" class="publication-abstract link text-dark" data-sroll-ignore data-toggle="modal" data-target="#publications-modal">[Abstract]</a>
                  </p>
