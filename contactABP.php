        ...
        <form action="contactABPProcess.php" method="post" id="corporateAPBForm">
          ...
          <div class="row my-5">
            <div class="col d-flex flex-column">
              ...
              <div class="form-group d-none"><!--HoneyPot-->
                <input type="text" class="form-control form-control-lg" name="fax" id="fax">
              </div>
              
              <button id="corpContactBtn" class="btn btn-outline-success btn-lg submit-btn mt-3 ml-auto">Submit</button>
              <i class="fas fa-spinner fa-2x fa-spin mt-4 ml-auto"></i><!--Initially hidden in the css-->
              <span class="submitMessage text-center mt-4 mb-3 ml-auto">Thank you, your message has been sent</span><!--Initially hidden in the css-->
            </div>
          </div>
