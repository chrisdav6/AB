...
<body class="d-flex flex-column">
  ...
  <section id="companyContent" class="py-4 mb-5">
        ...
        <div class="col-md-9">
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane active" id="overview" role="tabpanel">
              ...
              <p>Applied BioPhysics, Inc. applies the results of biophysical research to provide practical tools for
                cell research
                and drug discovery.
              </p>

              <p>
                ECIS<sup>&trade;</sup> or Electric Cell-substrate Impedance Sensing is an impedance based method to
                study many of
                the activities of animal cells when grown in tissue culture in real-time. These include morphological
                changes, cell
                locomotion, and other behaviors directed by the cell's cytoskeleton. ECIS<sup>&trade;</sup> technology
                was invented
                by Drs. Ivar Giaever and Charles R. Keese while working at General Electric Corporate Research and
                Development, but
                its commercial potential was not explored as it fell outside of GE's core interests. In 1991, as the
                applications
                of the technology became more apparent, Drs Giaever and Keese formed Applied BioPhysics, Inc. as a
                private company
                to develop, commercialize and market ECIS<sup>&trade;</sup> and other biophysical technologies. Applied
                BioPhysics
                is located next to the Rensselaer Polytechnic Institute campus, where several collaborative research
                projects are
              ...
              <p>
                ...
                investigations including measurements of the invasive nature of cancer cells, the barrier function of
                endothelial
                cells, in vitro toxicity testing as an alternative to animal testing, and signal transduction involving
                GPCR's
                for modern drug discovery.
                <p>

                  <p>
                    Instruments are located throughout the United States as well as in Asia and Europe. Customers
                    include Johns
                    Hopkins University, The University of Tokyo, Vanderbilt University, Brown University, Genentech, and
                    Allergan
                    to mention a few. Drs. Giaever and Keese continue to develop new innovations to enhance the ECIS
                    technology
                    including most recently an automated wound healing assay and a device to study the behavior of cells
                    under
            ...
            <div class="tab-pane" id="whoWeAre" role="tabpanel">
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-9 col-lg-10">
                  ...
                  <p>
                    ...
                    Development
                    Center, in addition to co-inventing the ECIS technology, he was involved in the development of the
                    indium
                    slide immunoassay and the use of fluorocarbon fluids as substrates for cell growth culminating in
                    the first
                    liquid microcarrier.
                  </p>
                </div>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-9 col-lg-10">
                  ...
                  <p>
                    The company's Chief Technology Officer, Ivar Giaever, is a highly recognized physicist who shared
                    the 1973
                    Nobel Prize in Physics for his studies of tunneling and superconductivity. He then became interested
                    in
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-9 col-lg-10">
                  ...
                  <p>
                    Christian Dehnert, Vice President Marketing, holds a BS and MS in electrical engineering and a MBA
                    with an
            ...
            <div class="tab-pane" id="mission" role="tabpanel">
              ...
              <div class="row">
                <div class="col">
                  <p>
                    Applied BioPhysics manufactures <strong>ECIS<sup>&trade;</sup> (Electric Cell-Substrate Impedance
                      Sensing)</strong>
                    instruments and arrays for monitoring the behavior of cells in tissue culture. We not only pride
                    ourselves for
                    being the founders of an automated, quantitative, real-time instrument, we also pride ourselves on
                    being as
                    academic minded as we are business savy. Our primary intention is to provide an instrument that
                    answers the
                    researchers experimental question(s). A system sitting idle is as much of a loss to you as it is to
                    our company.
                  </p>
                </div>
              </div>
              ...
              <div class="row mt-2">
                <div class="col-lg-6 mb-4 mb-lg-0">
                  <img class="img-fluid" src="public/img/mission.jpg" alt="Applied Biophysics Group Photo">
                </div>

                <div class="col-lg-6">
                  <p>
                    We thrive on creating a strong ECIS<sup>&trade;</sup> community, a network between
                    ECIS<sup>&trade;</sup> users,
                    and with Applied BioPhysics. We rely heavily on peer reviewed publications to learn about how ECIS
                    is being used
                    for various applications. In turn we are able to connect ECIS™ users with one another when questions
                    arise about
              ...
              <div class="row mt-4">
                <div class="col">
                  <p>
                    We have a dedicated team of employees that make our customers and their research a priority. It is
                    not uncommon
                    for us to make ourselves available after hours when researchers have questions, or need assistance.
                  </p>
                  <p>All of our products are manufactured in the USA, 95 percent of which are manufactured at our
                    facility in Troy, NY.</p>
                  <p>
                    Applied BioPhysics, Inc. has a mission to bring you innovative technology to benefit your research,
                    with
                    guaranteed satisfaction through manufacturing and person to person communication. Reliable,
                    reproducible, and
                  ...
                  <p>
                    Applied BioPhysics is dedicated to minimizing its environmental impact, and ensuring a sustainable
                    future by
                    finding opportunities within both its operations and business practices to promote environmentally
                    sound choices.
                  </p>
                  ...
                  <ul class="list-unstyled mt-3 ml-0 ml-md-3">
                    <li class="indent my-4 pl-0 pl-sm-4">
                      Continuing improvement in daily operations that contribute to the health and well-being of its
                      employees, as
                  ...
                  <p class="environment text-success mt-3"><i class="fas fa-leaf fa-flip-horizontal mr-2"></i>Please
                    consider the environment before printing.</p>
                </div>
              </div>
            </div><!-- /mission -->
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-9 col-lg-10">
                  ...
                  <p>
                    ...
                    circuit
                    development, MEMS, digital cinema and life sciences instrumentation. In previous roles with DALSA,
                    Mr. Litwiller
                    was the head of marketing, and before that, the head of engineering. Prior to joining DALSA, Mr.
                    Litwiller was a
                    design engineer at several high technology start-ups in the wireless, fiber optic telecom, and
                    broadcast
                    industries.
                  </p>
                  <p>
                    Mr. Litwiller is a graduate of the University of Waterloo, and holds a Bachelor of Applied Science
                    degree. He
                    serves as an advisor for various private corporations in matters of strategy, technology, and
                    business
                    development. Mr. Litwiller is a frequent speaker at technology start-up forums and executive
              ...
              <div class="row">
                ...
                <div class="col-md-9 col-lg-10">
                  ...
                  <p>
                    ...
                    diploma in
                    chemistry and received his PhD from the University of Muenster in 1998. His research interests are
                    focussed on
                    the development of non-invasive whole-cell biosensors that can be applied to follow the behaviour of
                    mammalian
                    cells in vitro. As the analysis of living systems is a complex task, Wegener’s research aims to
                    bring together
                    several sensoric principles in one device (multi-parametric sensing) so that more than one parameter
                    can be
                    recorded from a given cell population simultaneously. He has authored numerous research papers, book
                    chapters and
                    review articles on this subject. Wegener teaches courses in biochemistry, cell biology, biosensors &
                    bioanalytics
                    at the undergraduate and graduate level.
                  </p>
                  <p>
                    Joachim Wegener started to work with ECIS and related techniques in 1993 inspired by the
                    publications of Ivar
                    Giaever and Charles Keese, the founders of Applied BioPhysics Inc. After having received his PhD, he
                    joined the
                    Giaever lab for two years working as a postdoc with Giaever & Keese on cell adhesion,
                    electroporation and cell
                    wounding - all based on the ECIS technology. Since this time he has strong interest in modeling and
                    simulating
                    the electrical properties of living animal cells on conducting surfaces and developing new
            ...
            <div class="tab-pane" id="press" role="tabpanel">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/transFilterArray.pdf" target="_blank">Continuous
                      measurement of cell
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/WenJiangBookPressRelease.pdf" target="_blank">Electric
                      Cell-Substrate
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/Stemnion.pdf" target="_blank">Stemnion uses ECIS to
                      Measure Placental
                      Stem Cells</a></p>
                </div>
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/RegensburgMtg.pdf" target="_blank">1st Conference on
                      Impedance-Based
                      Cellular Assays</a></p>
                </div>
                ...
                <div class="col-md-6 mb-4">
                  <h3 class="pressTitle">June 2011</h3>
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/NoblePrize.pdf" target="_blank">How to Win a Nobel
                      Prize</a></p>
                </div>
                ...
                <div class="col-md-6 mb-4">
                  <h3 class="pressTitle">June 2011</h3>
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/StageArrayHolder.pdf" target="_blank">Microscope Stage
                      Holder for
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/CellProliferationRelease.pdf" target="_blank">Automated
                      Cell
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/ElectricFencePress.pdf" target="_blank">Electric Fence
                      Array - Method
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <hr class="mt-0">
                  <p><a class="text-dark link" href="public/pdf/LineWoundingPress.pdf" target="_blank">Line Wounding
                      Array -
  ...
  <div class="modal fade" id="customerTrainingModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <p>
            Professor Chu Ming Lo of Yang Ming University of Taiwan leading a session on ECIS Theory during a customer
            training
          ...
          <p>
            The ECIS training course was given in cooperation between Dakewe and Sunpoint and allowed for ECIS training
            in Chinese.
            ECIS training courses have taken place in Troy, NY, Munich, Germany, Taipei, Taiwan and most recently
            Shanghai, China.
            For inquiries as to the next ECIS training course please contact Applied BioPhysics or the distributor
            nearest you.
          </p>
        </div>
      </div>
  ...
  <div class="modal fade" id="koreaModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <p>
            The annual conference of Korea Federation of Women's Science and Technology Association (KOFWST) was held on
