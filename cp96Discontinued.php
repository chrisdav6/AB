...
<body class="d-flex flex-column">
  ...
  <section id="productHeading" class="pb-4 text-center text-md-left">
    <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="display-2">ECIS<sup class="registered">®</sup> CP96</h1>
          <hr class="my-2">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 text-center text-md-left mt-4">
          ...
          <a href="public/pdf/CP96DataSheetR6.pdf" target="_blank" class="btn btn-outline-success productBtn mr-0 mr-md-1" role="button">Download Data
            Sheet</a>
        ...
        <div class="col">
          ...
          <div class="row mt-4">
            <div class="col-md-3 pb-4 pb-md-0">
              <a href="public/pdf/CP96DataSheetR6.pdf" target="_blank" data-toggle="tooltip" data-placement="right" title="Download CP96 Data Sheet">
