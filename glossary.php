        ...
        <div class="row">
          <div class="col">
            ...
            <div class="item">
              <h4>Well</h4>
              <p class="pl-0 pl-md-3">
                A 0.9 cm<sup>2</sup> chamber that houses both an electrode and counter electrode where cells can be cultured and observed. Each well holds 500 microliters of medium.
              </p>
            </div>
