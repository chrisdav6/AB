<?php
  $title = "International Distributors - Applied Biophysics";
  $metaDesc = "Applied BioPhysics partners with companies around the world for distribution of ECIS instruments and
  products.";
?>
...
<body class="d-flex flex-column">
  ...
  <section id="distributorsContent" class="py-4 mb-5">
      ...
      <div class="distributorsList">
        <div class="row">
          ...
          <div class="col-md-6 my-4">
            <h3>Korea</h3>
            <hr class="mb-4">
            <h5><a class="text-dark link" href="http://www.lbscience.com" target="_blank">LeeBaeg Science Co., Ltd.</a>
            </h5>
            <address>
              Second Floor<br>
              626-1Guam-Dong<br>
          ...
          <div class="col-md-6 my-4">
            <h3>Taiwan</h3>
            <hr class="mb-4">
            <h5><a class="text-dark link" href="http://www.sunpointworld.com" target="_blank">Sunpoint Scientific
                Instrument Co., Ltd.</a></h5>
            <address>
