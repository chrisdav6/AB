  ...
  <body class="d-flex flex-column">
    ...
    <section id="techSupportContent" class="py-4 mb-5">
      <div class="container text-center text-md-left">
        ...
        <div class="supportDocs">
          <p><a href="https://link.springer.com/article/10.1007/s00424-014-1674-0?view=classic" class="link text-dark" target="_blank">Impedance analysis of GPCR-mediated changes in endothelial barrier function: Overview, and fundamental considerations for stable and reproducible measurements</a></p>
        </div>

        <h4 class="mt-5 mb-4 secondary-title">Books</h4>

        <div class="supportDocs">
          <p><a href="https://www.springer.com/us/book/9789400749269" class="link text-dark" target="_blank">Electric Cell-Substrate Impedance Sensing and Cancer Metastasis" is available from Springer Netherlands</a></p>
        </div>

        <h4 class="mt-5 mb-4 secondary-title">JOVE Videos</h4>

        <div class="supportDocs">
          <p><a href="https://www.jove.com/video/51300/electric-cell-substrate-impedance-sensing-for-quantification" class="link text-dark" target="_blank"><i class="fas fa-video mr-2"></i> Electric Cell-substrate Impedance Sensing for the Quantification of Endothelial Proliferation, Barrier Function, and Motility (12min)</a></p>
          <p><a href="https://www.jove.com/video/3840/measurement-of-cellular-chemotaxis-with-ecistaxis" class="link text-dark" target="_blank"><i class="fas fa-video mr-2"></i> Measurement of Cellular Chemotaxis with ECIS/Taxis (11min)</a></p>
        </div>
        ...
        <div class="supportDocs">
          ...
          <p><a href="public/pdf/Pre-CoatingElectrodeswithDefinedProteinCoats.pdf" class="link text-dark" target="_blank"><i class="far fa-file-pdf mr-2"></i> Pre-Coating Electrodes with Defined Protein Coats</a></p>
