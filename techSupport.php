...
<body class="d-flex flex-column">
  ...
  <section id="techSupportContent" class="py-4 mb-5">
    <div class="container text-center text-md-left">
      ...
      <div class="supportDocs">
        <p><a href="https://www.jove.com/video/51300/electric-cell-substrate-impedance-sensing-for-quantification" class="link text-dark" target="_blank"><i class="fas fa-video mr-2"></i> Electric Cell-substrate Impedance
