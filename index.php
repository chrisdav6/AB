          ...
          <a href="webinars.php" class="text-dark">
            <div class="card text-center">
              <div class="card-body">
                ...
                <h4 class="mb-1">September 5, 2023</h4>
          ...
          <a href="tradeShows.php" class="text-dark">
            <div class="card text-center">
              <div class="card-body">
                ...
                <!-- <h4 class="mb-1">April 14-19, 2023</h4>
                <p class="card-text mb-0">AACR Annual Meeting 2023</p>
                <p class="card-text mb-0">Orlando, FL</p> -->
              </div>
            </div>
          </a>
        </div>
