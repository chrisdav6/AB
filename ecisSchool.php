          ...
          <div class="modal-body">
            <figure class="figure">
              ...
              <figcaption class="figure-caption">
                From left to right: Dennis Grab - Uniformed Services University of the Health Sciences, Ivar Giaever - Applied BioPhysics, Charles Keese - Applied BioPhysics, Jessica Neder - University of Maryland School of Medicine, Lili Gu - University of Maryland School of Medicine, Lin Zou - University of Maryland School of Medicine
              </figcaption>
            </figure>
            <div class="grad-text my-2">
              ...
              <p class="grad-desc">Research Focus: Determining the role of extracellular RNA in lung injury during sepsis.</p>
              <hr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <figure class="figure">
              ...
              <figcaption class="figure-caption">
                From left to right: Ivar Giaever - Applied BioPhysics, Susmita Bhattari - Louisiana State University Health Sciences Center, Ann Marie DiGeorge Foushee - Naval Medical Research Unit, Kirstin Morris - Naval Medical Research Unit, Joshua Sumislawski - University of Colorado, Erica Beatman - National Jewish Health, Kelly Schweitzer - National Jewish Health, Fang Niu - University of Nebraska Medical Center, Manikandan Panchatcharam - Louisiana State University Health Sciences Center, Charles Keese - Applied BioPhysics
              </figcaption>
            </figure>
            <div class="grad-text my-2">
              <p class="mb-0">Manikandan Panchatcharam, Ph.D.</p>
              <p class="grad-desc-title">Louisiana State University Health Sciences Center</p>
              <p class="grad-desc">Research Focus: Research focuses on lipids which play a major factor in blocking blood vessels leading to stroke and heart attack.</p>
              <hr>
              <p class="mb-0">Susmita Bhattarai Ph.D.</p>
              <p class="grad-desc-title">Student - Louisiana State University Health Sciences Center</p>
              <p class="grad-desc">Research Focus: Cardiovascular disease model focusing on the vascular functionality and muscular function.</p>
              <hr>
              <p class="mb-0">Kirstin Morris Ph.D.</p>
              <p class="grad-desc-title">Student at UTSA-UTHSCSA, Orise Research Fellow, NAMRU-SA, Naval Medical Research Unit</p>
              <p class="grad-desc">Research Focus: Developing an electrospun collagen based 3D scaffold that would improve bone regeneration after tooth extraction.</p>
              <hr>
              <p class="mb-0">Ann Marie DiGeorge Foushee</p>
              <p class="grad-desc-title">Research Technician Naval Medical Research Unit</p>
              <p class="grad-desc">Research Focus: Conduct research to improve operational readiness and safety of DOD personnel via development of novel wound dressings that address prevention of infection as well as promotion of wound healing.</p>
              <hr>
              ...
              <p class="grad-desc">Research Focus: Investigate mechanisms underlying cigarette smoke induced lung injury and to better understand lung alveolar cell death and recovery from various insults both in vitro and in vivo.</p>
              <hr>
              <p class="mb-0">Erica Beatman</p>
              <p class="grad-desc-title">Senior Research Technician - National Jewish Health</p>
              <p class="grad-desc">Research Focus: Investigating how to ameliorate lung damage induced by chronic cigarette smoke exposure by targeting specific lipids and enzymes associated with protection against the development of COPD and emphysema.</p>
              <hr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="grad-text my-2">
              ...
              <p class="grad-desc">Research Focus: Our lab's research efforts are focused on developing therapies against retinal inflammatory and vasoproliferative events occurring in diabetic retinopathy (DR), using in vitro cell culture models and animal models of diabetes. Specifically, in studies related to retinal inflammation, we test potential therapies against diabetes-induced compromise of the blood retinal barrier and leukostasis; for those related to vasoproliferation, we focus on the therapeutic blockade of endothelial cell migration, proliferation and tube formation.</p>
              <hr>
              <p class="mb-0">G. Cristina Brailoiu, MD</p>
              <p class="grad-desc-title">Jefferson College of Pharmacy, Thomas Jefferson University</p>
              <p class="grad-desc">Research Focus: Dr. Brailoiu is interested in GPCR signaling and cardiovascular regulation. She is planning to use ECIS to characterize the changes in barrier function of brain microvascular endothelial cells in response to GPCR agonists.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="grad-text my-2">
              ...
              <p class="grad-desc">Research Focus: Dr. Nektarios Barabutis is interested on the mechanisms which govern the regulation of vascular permeability in lung tissues. He has recently introduced the protective role of p53 on the LPS induced hyperpermeability and he is currently focused on the intracellular cascades which mediate that effect.</p>
              <hr>
              <p class="mb-0">Raji Rajesh Lenin, Ph.D</p>
              <p class="grad-desc-title">Gangaraju lab, Department of Ophthalmology, University of Tennessee Health Science Centre</p>
              <p class="grad-desc">Research Focus: Effect of hyperglycemia and TNF-α in ER stress induced tight junction alterations and vascular dysfunction in Human Retinal Endothelial cells. ECIS will be applied to understand the barrier functional changes in endothelial cells during diabetes.</p>
              <hr>
              <p class="mb-0">Koreana Pak</p>
              <p class="grad-desc-title">Pathology and Laboratory Medicine, University of Pennsylvania</p>
              <p class="grad-desc">Research Focus: Investigate the mechanisms underlying hypoxia-driven sarcoma metastasis, as well as the role of ECM in tumor cell extravasation.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="grad-text my-2">
              ...
              <p class="grad-desc">Research Focus: My research focus is to find ways to improve the proliferation potential of corneal endothelial cells so that they may be used for regenerative cell therapy.</p>
              <hr>
              <p class="mb-0">Christopher Turner, Ph.D.</p>
              <p class="grad-desc-title">University of British Columbia, Granville Lab, International Collaboration on Repair Discoveries (ICORD)</p>
