...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Label-free Real-time Automated Cell-based assays powered by the technology of ECIS. Developed by Nobel laureate Ivar
    ...
    <title>Applied Biophysics</title>
  </head>
  ...
  <body class="d-flex flex-column">
    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-light py-2 border-bottom">
        <div class="container px-3">
          <a class="navbar-brand" href="index.html"><img src="public/img/abLogoNavbar.png" alt="Applied Biophysics Round Logo"
              height="30"></a>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#">Management and Team Advisors</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">What is ECIS?</a>
                <div class="dropdown-menu">
    ...
    <section id="logo" class="py-5 mt-4 mt-md-0 border-bottom">
      <div class="container">
    ...
    <section id="applicationHeading" class="pt-5 text-center text-md-left">
      <div class="container">
        <div class="row">
          <div class="col">
        ...
        <div class="row text-center text-md-left">
          ...
          <div class="col-md-3">
            <ul class="list-unstyled">
              ...
              <li><a href="teer24.html">TEER24</a></li>
          ...
          <div class="col-md-3">
            <ul class="list-unstyled">
              <li><a href="whatIsECIS.html">What is ECIS?</a></li>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-9 text-center text-md-left">
            <p class="address mb-0 text-secondary">&copy; 2018 Applied BioPhysics, Inc.<br>185 Jordan Road Troy, NY
              12180 / <a href="tel:518-880-6860" class="text-secondary">Phone: 518-880-6860</a> / <a href="tel:866-301-3247"
                class="text-secondary">Toll Free: 866-301-ECIS (3247)</a> / Fax: 518-880-6865</p>
          </div>
          <div class="col-md-3 text-center text-md-right mt-4 mt-md-0">
            <p class="mb-0"><a class="social facebook" href="https://www.facebook.com/Applied-BioPhysics-165532397615/"
                target="_blank"><i class="fab fa-facebook-square fa-3x"></i></a></p>
          </div>
        </div>
      </div>
    </section> <!-- /copyright -->
