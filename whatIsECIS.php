  ...
  <section id="technologyContent" class="py-4 mb-5 text-center text-md-left">
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <p class="mb-0">
            ECIS<sup>&reg;</sup> (Electric Cell-substrate Impedance Sensing) is a real-time, label-free, impedance-based
            method to study the activities of cells grown in tissue culture. These include morphological changes, cell
            locomotion, and other behaviors directed by the cell’s cytoskeleton. This impedance-based cell monitoring
            technology was invented by Drs. Ivar Giaever and Charles R. Keese who founded Applied BioPhysics, Inc.
          </p>
          <img class="img-fluid py-5 d-block mx-auto" src="public/img/ecisWorks.jpg" alt="ECIS Illustration">
          <p class="mb-0">
            The ECIS<sup>&reg;</sup> approach has been applied to numerous investigations including measurements of the
            invasive nature of cancer cells, the barrier function of endothelial cells, in vitro toxicity testing as an
            alternative to animal testing, and signal transduction involving GPCR’s for modern drug discovery.
          </p>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p>
            Cell function modulates cell morphology. ECIS is capable of detecting and quantifying morphology changes in
            the sub-nanometer to micrometer range. In ECIS a small alternating current (I) is applied across the
            electrode pattern at the bottom of the ECIS arrays (direct current cannot be used). This results in a
            potential (V) across the electrodes which is measured by the ECIS instrument. The impedance (Z) is
            determined by Ohm’s law Z = V/I.
          </p>
          <p>
            When cells are added to the ECIS Arrays and attach to the electrodes, they act as insulators increasing the
            impedance. As cells grow and cover the electrodes, the current is impeded in a manner related to the number
            of cells covering the electrode, the morphology of the cells and the nature of the cell attachment. When
            cells are stimulated to change their function, the accompanying changes in cell morphology alter the
            impedance. The data generated is impedance versus time.
          </p>
        </div>
        <div class="col-md-6">
          <h2 class="mt-5 mt-md-0">How Frequencies Reveal Cell Behavior</h2>
          <p>
            Why are multiple AC frequencies important? To understand why AC frequency is important in ECIS we have to
            consider how frequency affects the current paths with cell-covered electrodes. (Note: the total current is
            maintained constant and voltage changes are measured.) At relatively low frequencies (&lt; 2,000Hz) most of
            the current flows in the solution channels under and between adjacent cells (red lines).
          </p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col">
          ...
          <p>
            With the more advanced ZΘ instrument, where the impedance is broken down into its components (resistance and
            capacitance), quantitative information about the cells can be obtained by modeling (Giaever and Keese PNAS
            1991). Using impedance data at multiple AC frequencies the ECIS model calculates time course changes in:
          </p>
